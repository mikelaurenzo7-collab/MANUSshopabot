...
function OnboardingGuard() {
  ...
  useEffect(() => {
    ...
    const hasOnboarded = localStorage.getItem("orchaistrate_onboarded") || localStorage.getItem("beastbots_onboarded") || localStorage.getItem("shopbots_onboarded") || localStorage.getItem("shopbot_onboarded");
    if (!hasOnboarded) {
