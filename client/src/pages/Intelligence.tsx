            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {[
                  ...
                  { name: "Creative Velocity", freq: "Every 4h", agent: "Growth" },
                  { name: "Ad Performance", freq: "Every 4h", agent: "Growth" },
                  { name: "Scheduled Posts", freq: "Every 5min", agent: "Growth" },
                  { name: "Email Recovery", freq: "Every 1h", agent: "Growth" },
                  { name: "Store Health", freq: "Every 6h", agent: "Launch" },
                  { name: "Token Refresh", freq: "Every 1h", agent: "Launch" },
                  { name: "Competitor Scan", freq: "Wed & Sat 4AM", agent: "Launch" },
