...
const BOT_META: Record<AgentType, {
  ...
  architect: {
    ...
    accent: "text-sky-300", border: "border-sky-500/25", glow: "shadow-[0_0_24px_rgba(14,165,233,0.12)]",
    dot: "bg-sky-400",
  },
  merchant: {
    ...
    accent: "text-cyan-300", border: "border-cyan-500/25", glow: "shadow-[0_0_24px_rgba(34,211,238,0.10)]",
    dot: "bg-cyan-400",
  },
  social: {
    ...
    accent: "text-fuchsia-300", border: "border-fuchsia-500/25", glow: "shadow-[0_0_24px_rgba(217,70,239,0.10)]",
    dot: "bg-fuchsia-400",
  },
};
...
export default function Home() {
  ...
  const { data: recentWorkflows } = trpc.workflows.history.useQuery({ limit: 5 }, { refetchInterval: 30_000 });
