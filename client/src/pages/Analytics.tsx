...
import { CHART_COLORS, TOOLTIP_STYLE, LABEL_STYLE } from "@/lib/chartTheme";
              ...
              <div className="h-64" role="img" aria-label={`Revenue trend chart showing ${revenueData.length} data points`}>
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={revenueData}>
                    ...
                    <YAxis tick={{ fill: "var(--muted-foreground)", fontSize: 10 }} tickLine={false} axisLine={false} tickFormatter={(v) => `$${v}`} />
                    <Tooltip contentStyle={TOOLTIP_STYLE} labelStyle={LABEL_STYLE} itemStyle={{ color: "var(--chart-1)" }} />
            ...
            <div className="h-52" role="img" aria-label={`Top products bar chart with ${topProducts.length} items`}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topProducts} layout="vertical">
                  ...
                  <YAxis type="category" dataKey="name" tick={{ fill: "var(--muted-foreground)", fontSize: 11 }} tickLine={false} axisLine={false} width={150} />
