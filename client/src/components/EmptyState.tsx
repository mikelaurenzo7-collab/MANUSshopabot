    ...
    <div className={`empty-state ${className ?? ""}`.trim()}>
      ...
      {action &&
        (action.href ? (
          <Link
            href={action.href}
            className="mt-4 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-sky-500/15 border border-sky-500/30 text-xs font-semibold text-sky-200 hover:bg-sky-500/25 hover:border-sky-400/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500/50"
          >
            {action.label}
