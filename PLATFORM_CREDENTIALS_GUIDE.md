# Beast Bots Platform Credentials Guide
...
- Configure secrets in Beast Bots
...
3. **If you create them**: Provide the credentials for each platform, and I'll configure them in Beast Bots.
